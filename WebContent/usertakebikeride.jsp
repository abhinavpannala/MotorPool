...
<div class="row">
	<div class="panel panel-info">
		<div class="panel-heading">
			<i class="fa fa-motorcycle fa-fw"></i> Available Rides
		</div>
			...
			<table class="table table-hover">
				...
				<tbody>
					<tr>
						...
						<td><%=user.getName() %></td>
						<td><%=user.getPhone() %></td>
						<td><%=user.getBikeno() %></td>
						<td><%=user.getBiketype() %></td>
						<td><%=ride.getRidepoints() %></td>
						<td>
							<a href="joinride?ridetype=bike&rideid=<%=ride.getRideid()%>" class="btn btn-warning"><i class="fa fa-hand-o-right" aria-hidden="true"></i> Join Ride</a>
						</td>
					</tr>
					<%
					}
